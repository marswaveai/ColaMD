...
- v2.0.2 — Faster Windows large-document opening, reset reading position on file switch, resizable sidebar, and reading-progress outline; find/replace with balanced search controls
